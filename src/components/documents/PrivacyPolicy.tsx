                    ...
                    <Col md={{ span: 8, offset: 2 }}>
                        ...
                        <Row>
                            <Col>
                                ...
                                <Row className="mt-4">
                                    <Col>
                                        <h4 className={styles.sectionTitle}>Description of the Service</h4>
                                        <p>
                                ...
                                <Row className="mt-4">
                                    <Col>
                                        <h4 className={styles.sectionTitle}>Data controller</h4>
                                        <p>
                                ...
                                <Row className="mt-4">
                                    <Col>
                                        <h4 className={styles.sectionTitle}>Data controller’s data protection officer</h4>
                                        <p>
                                            Hans Dautzenberg <br />
                                            Naturalis Biodiversity Center <br />
                                            Darwinweg 2 <br />
                                ...
                                <Row className="mt-4">
                                    <Col>
                                        <h4 className={styles.sectionTitle}>Jurisdiction and supervisory authority</h4>
                                        <p>
                                ...
                                <Row className="mt-4">
                                    <Col>
                                        <h4 className={styles.sectionTitle}>Personal data processed</h4>
                                        <p>
                                            The Login service may process the following personal data:
                                        </p> <br />
                                        <p className="fw-bold"> Identification data: </p>
                                        <ul>
                                            <li> Name </li>
                                            <li>
                                        ...
                                        <p className="fw-bold"> Behavioural data: </p>
                                        <ul>
                                            <li> Usage data (websites, services, social media) </li>
                                            <li> Login timestamps </li>
                                        </ul>

                                        <p className="fw-bold"> Collaboration data: </p>
                                        <ul>
                                ...
                                <Row className="mt-4">
                                    <Col>
                                        <h4 className={styles.sectionTitle}>Purpose of the processing of personal data</h4>
                                        <p> The purpose of the collection, processing and use of the personal data mentioned above is: </p> <br />
                                ...
                                <Row className="mt-4">
                                    <Col>
                                        <h4 className={styles.sectionTitle}>Legal basis</h4>
                                        <p>
                                ...
                                <Row className="mt-4">
                                    <Col>
                                        <h4 className={styles.sectionTitle}>Third parties to whom personal data is disclosed</h4>
                                        <p>
                                        ...
                                        <p className="fw-bold"> Within the EU / EEA: </p>
                                        <ul>
                                        ...
                                        <p className="fw-bold"> Outside the EU / EEA: </p>
                                        <ul>
                                ...
                                <Row className="mt-4">
                                    <Col>
                                        ...
                                        <p> To access your profile information, you can go to your user profile page. </p> <br />
                                        <p>
                                ...
                                <Row className="mt-4">
                                    <Col>
                                        <h4 className={styles.sectionTitle}>Data retention and deletion</h4>
                                        <p>
                                ...
                                <Row className="mt-4 mb-4">
                                    <Col>
                                        <h4 className={styles.sectionTitle}>Additional Policies</h4>
                                        <p>
